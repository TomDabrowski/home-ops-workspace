...
function buildBaselineLineItems(anchorMonthKey: string): BaselineLineItem[] {
  ...
  return [
    ...
    },
    {
      ...
      cadence: "monthly",
      effectiveFrom: historicalStart,
      notes: "Aus Bilanz jaehrlich auf Monat heruntergebrochen: 68.352 EUR pro Jahr.",
    },
    {
      id: "reserve-legal-insurance",
      label: "Rechtsschutzversicherung Auxilia",
      amount: 25,
      category: "annual_reserve",
      cadence: "monthly",
      effectiveFrom: "2024-05",
      notes: "Aus Bilanz jaehrlich auf Monat heruntergebrochen: 300 EUR pro Jahr.",
    },
    {
      id: "reserve-liability-insurance",
      label: "Haftpflichtversicherung AIG",
      amount: 6.83,
      category: "annual_reserve",
      cadence: "monthly",
      effectiveFrom: anchorMonthKey,
      notes: "Aus Bilanz jaehrlich auf Monat heruntergebrochen: 81.96 EUR pro Jahr.",
    },
    {
